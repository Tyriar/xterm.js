...
var Renderer = (function (_super) {
    ...
    function Renderer(_terminal) {
        ...
        _this._colorManager = new ColorManager_1.ColorManager();
        _this._renderLayers = [
            new BackgroundRenderLayer_1.BackgroundRenderLayer(_this._terminal.element, 0, _this._colorManager.colors),
            new SelectionRenderLayer_1.SelectionRenderLayer(_this._terminal.element, 1, _this._colorManager.colors),
            new ForegroundRenderLayer_1.ForegroundRenderLayer(_this._terminal.element, 2, _this._colorManager.colors),
            new LinkRenderLayer_1.LinkRenderLayer(_this._terminal.element, 3, _this._colorManager.colors, _this._terminal),
            new CursorRenderLayer_1.CursorRenderLayer(_this._terminal.element, 4, _this._colorManager.colors)
        ];
        _this.dimensions = {
