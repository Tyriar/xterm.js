...
export class InputHandler implements IInputHandler {
  ...
  public insertLines(params: number[]): void {
    ...
    while (param--) {
      ...
      this._terminal.buffer.lines.splice(row, 0, this._terminal.buffer.blankLine(true));
  ...
  public deleteLines(params: number[]): void {
    ...
    while (param--) {
      ...
      // blankLine(true) - xterm/linux behavior
      this._terminal.buffer.lines.splice(j + 1, 0, this._terminal.buffer.blankLine(true));
  ...
  public scrollUp(params: number[]): void {
    ...
    while (param--) {
      ...
      this._terminal.buffer.lines.splice(this._terminal.ybase + this._terminal.scrollBottom, 0, this._terminal.buffer.blankLine());
    }
    // this.maxRange();
  ...
  public scrollDown(params: number[]): void {
    ...
    while (param--) {
      ...
      this._terminal.buffer.lines.splice(this._terminal.ybase + this._terminal.scrollTop, 0, this._terminal.buffer.blankLine());
    }
    // this.maxRange();
    this._terminal.updateRange(this._terminal.scrollTop);
    this._terminal.updateRange(this._terminal.scrollBottom);
    ...
    if (!this._terminal.prefix) {
      ...
      switch (params[0]) {
        ...
        case 1047: // normal screen buffer - clearing it first
          if (this._terminal.normal) {
            this._terminal.buffer = this._terminal.normal.buffer;
